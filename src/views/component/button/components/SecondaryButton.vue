<template>
  <n-card>
    ...
    <n-space>
      ...
      <n-button strong secondary circle :render-icon="renderButtonIcon"></n-button>
      <n-button strong secondary circle type="primary" :render-icon="renderButtonIcon"></n-button>
      <n-button strong secondary circle type="info" :render-icon="renderButtonIcon"></n-button>
      <n-button strong secondary circle type="success" :render-icon="renderButtonIcon"></n-button>
      <n-button strong secondary circle type="warning" :render-icon="renderButtonIcon"></n-button>
      <n-button strong secondary circle type="error" :render-icon="renderButtonIcon"></n-button>
    </n-space>
  </n-card>
</template>
