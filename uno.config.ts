...
export default defineConfig({
  ...
  shortcuts: {
    'base-container': 'flex flex-col gap-10px mx-10px mb-10px px-3 py-2 h-[calc(100%-20px)] bg-[var(--n-color)] border-rd-1 overflow-y-auto transition duration-300 ease-[var(--n-bezier)]',
